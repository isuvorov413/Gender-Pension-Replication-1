...
if $modelfit==1{
	...
	*global varlist1 "id year married female wage hage shw sww sformh sformw savrate pensionw pensionh wealth numk kidnow hexper hfexper wexper wfexper earnh earnw mpenwithdraw fpenwithdraw hed wed"
	global varlist1 "id year married female wage hage shw sww sformh sformw singlesamp pensionw pensionh wealth numk kidnow hexper hfexper wexper wfexper earnh earnw mpenwithdraw fpenwithdraw  hed wed sdiv TaxableIncomeh TaxableIncomew "
	*global varlist1 "id year married female wage hage shw sww sformh sformw numk kidnow wed hed savrate pensionw pensionh wealth hexper hfexper wexper wfexper earnh earnw  mpenwithdraw fpenwithdraw"  
	...
	global path1 "$modelfitpath/../inputs"
	global file1 "dataformoments.txt"

	global path2 "$simpath"
...
if ($SRimpacts==1) {
	global path1 "$oldsyspath"
	global file1 "simdata.asc"
	*"simdatanorefo.asc"
