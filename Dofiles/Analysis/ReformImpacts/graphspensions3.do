...
**************************************************************
local outfile = "$graphpath\pensionsmaried"
...
twoway 	histogram 	`outcome' if $year & `restriction2' & `restriction3',`option1' `yrange' ///
			`option3' `legendmacro' `xtitlemacro' saving(temp1,replace)
local xtitlemacro= `"xtitle("Million CLP") title("") ytitle("With Reform")"'
twoway 	histogram 	`outcome'_sim if $year & `restriction2' & `restriction3',`option2' `yrange' ///
			`option3' `legendmacro' `xtitlemacro' saving(temp1_sim,replace)
...
twoway 	histogram 	`outcome' if $year & `restriction2' & `restriction3',`option1' `yrange' ///
		`option3' `legendmacro' `xtitlemacro' saving(temp2,replace)
		
local xtitlemacro= `"xtitle("Million CLP") title("") ytitle("")"'
twoway 	histogram	`outcome'_sim if $year & `restriction2' & `restriction3',`option2'	`yrange' ///
		`option3' `legendmacro' `xtitlemacro' saving(temp2_sim,replace)
...
twoway 	histogram 	`outcome' if $year & `restriction2' & `restriction3',`option1'`yrange' ///
		`option3' `legendmacro' `xtitlemacro' saving(temp3,replace)
		
local xtitlemacro= `"xtitle("Million CLP") title("") ytitle("")"'
twoway 	histogram	`outcome'_sim if $year & `restriction2' & `restriction3',`option2' `yrange'	///
		`option3' `legendmacro' `xtitlemacro' saving(temp3_sim,replace)
...
local xtitlemacro= `"xtitle("") title("Single") ytitle("")"'
twoway 	histogram 	`outcome' if $year & `restriction2' & `restriction3',`option1' `yrange' ///
		`option3' `legendmacro' `xtitlemacro' saving(temp4,replace)
local xtitlemacro= `"xtitle("Million CLP") title("") ytitle("")"'
twoway 	histogram	`outcome'_sim if $year & `restriction2' & `restriction3',`option2'	`yrange' ///
		`option3' `legendmacro' `xtitlemacro' saving(temp4_sim,replace)
...
local outfile = "$graphpath\pensionsschool"
local legendmacro =`"legend(off)"'
local notemacro = `"note("Note 1: Pensions are topcoded at 3 million pesos for legibility")"'
